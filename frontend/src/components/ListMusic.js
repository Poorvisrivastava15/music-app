...
const ListMusic = () => {
  ...
  const displayMusic = () => {
    return MusicList.map((Music, index) => (
      <div className="col-md-3 col-lg-3 mb-4 mb-lg-0">
        <div className="card">
            <div style={{
                backgroundImage: `url('${url + "/" + Music.image}')`,
                minHeight: 200,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat'
            }}></div>
          {/* <img src={url + "/" + Music.image} className="card-img-top" alt="Laptop" /> */}
          <div className="card-body">
            <div className="d-flex justify-content-between">
              ...
              <p className="small text-danger">{Music.publisher}</p>
            </div>
            <div className="d-flex justify-content-between mb-3">
              ...
              <p>By {Music.artist}</p>
            <div className="mb-2">
              <p className="text-muted mb-0">{/* {Music.description.slice(0, 20)+(Music.description.length > 20 ? '...':'')} */}</p>
  ...
  return (
    <div>
        ...
        <div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel">
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item active">
              <img src="https://www.mediasource.mx/hubfs/blog-files/podcast.jpg" className="d-block w-100" alt="Sunset Over the City" />
      ...
      {selMusic ? <MusicPlayer file={url + "/" + selMusic.file} title={selMusic.title} artist={selMusic.artist} /> : ""}
    </div>
  )
}
