          ...
          <div className="card-body">
			<div className="row">
				<div className="col-md-4">
					<div style={{
						backgroundImage: "url('https://chrissoundlab.com/wp-content/uploads/2020/09/Complete-Studio-e1601291681297-1024x576.png')",
				...
				<Formik initialValues={{ title: "", genre: "", artist: "", year: "", lyrics: "", publisher: "" }} onSubmit={userSubmit}>
              {({ values, handleSubmit, handleChange }) => (
                <form onSubmit={handleSubmit}>
                  ...
                  <label>Artist</label>
                  <input className="form-control" id="artist" onChange={handleChange} value={values.artist} />
                  <label>Year</label>
                  <input className="form-control" id="year" onChange={handleChange} value={values.year} />
                  <label>Lyrics</label>
                  <textarea rows={4} className="form-control" id="lyrics" onChange={handleChange} value={values.lyrics}></textarea>
